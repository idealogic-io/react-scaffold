...
const StyledContainer = styled(ToastContainer)`
  ...
  .Toastify__toast--info {
    background-color: ${({ theme }) => theme.colors.link50};
  }
  .Toastify__toast--success {
    background-color: ${({ theme }) => theme.colors.success50};
  }
  ...
  .Toastify__progress-bar--info {
    background-color: ${({ theme }) => theme.colors.link500};
  }
  .Toastify__progress-bar--success {
    background-color: ${({ theme }) => theme.colors.success500};
  }
  .Toastify__progress-bar--warning {
    background-color: ${({ theme }) => theme.colors.warning500};
  }
